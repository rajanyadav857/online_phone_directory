...
<form class="text-center border border-light p-5" action="docreate_group.php" method="POST">
    ...
    <!-- Name -->
    <!-- Send button -->
    <button class="btn btn-info btn-block" type="submit" name="submit">Create</button>
